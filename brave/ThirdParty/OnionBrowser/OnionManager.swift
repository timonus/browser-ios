...
let DID_INTRO = "did_intro"
let USE_BRIDGES = "use_bridges"
let CUSTOM_BRIDGES = "custom_bridges"
let IPV4V6 = "ipv4v6"
let LOCALE = "locale"

// Choices for USE_BRIDGES
let USE_BRIDGES_NONE = 0
let USE_BRIDGES_OBFS4 = 1
let USE_BRIDGES_MEEKAMAZON = 2
let USE_BRIDGES_MEEKAZURE = 3
let USE_BRIDGES_CUSTOM = 99
...
class ObfsThread: Thread {
    ...
    var meekSocksPort: UInt = 0
    var obfs2SocksPort: UInt = 0
    var obfs3SocksPort: UInt = 0
    var scramblesuitSocksPort: UInt = 0
    
    override func main() {
        obfs4SocksPort = 47351
        meekSocksPort = 47352
        obfs2SocksPort = 47353
        obfs3SocksPort = 47354
        scramblesuitSocksPort = 47355
        
        GoIobfs4proxyMain()
    }
}

@objc protocol OnionManagerDelegate {
    func torConnProgress(_ progress: Int) -> Void
    func torConnFinished() -> Void
    func torConnError() -> Void
}
