...
class ReadabilityOperation: Operation, WKNavigationDelegate, ReadabilityBrowserHelperDelegate {
    var url: URL
    ...
    func readabilityBrowserHelper(_ readabilityBrowserHelper: ReadabilityBrowserHelper, didFinishWithReadabilityResult readabilityResult: ReadabilityResult) {
