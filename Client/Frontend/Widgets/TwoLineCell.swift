...
struct TwoLineCellUX {
    ...
    static let TextColor = UIAccessibilityDarkerSystemColorsEnabled() ? BraveUX.GreyJ : BraveUX.GreyH
...
class HistoryTableViewCell: TwoLineTableViewCell {
    ...
    func updateTextLabelWidthForEditing(_ editingMode:Bool) {
        if let frame:CGRect = self.textLabel?.frame {
    ...
    override func willTransition(to state: UITableViewCellStateMask) {
        ...
        else if state == UITableViewCellStateMask() {
            editingState = false
        }
