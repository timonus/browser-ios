...
extension Strings {
    ...
    public static let ScanSyncCode = NSLocalizedString("Scan a sync chain code", comment: "Scan sync code button title")
    public static let SyncAddDevice = NSLocalizedString("Add Device", comment: "Add device to sync")
    public static let SyncAddMobile = NSLocalizedString("Scan this sync code", comment: "Add mobile device to sync")
    public static let SyncAddComputer = NSLocalizedString("Enter the sync chain code", comment: "Add computer to sync")
    ...
    public static let SyncAddMobileDescription = NSLocalizedString("Using a second phone or tablet, navigate to Brave Settings > Sync > Scan. \n\nCapture the QR Code (above) with your second device, or enter code words if no camera is available.", comment: "Sync add device description")
    public static let SyncAddComputerDescription = NSLocalizedString("On your laptop, navigate to Brave Settings > Sync. Choose “Enter a Sync Chain Code.” \n\nEnter the code words above, including spaces.", comment: "Sync add device description")
